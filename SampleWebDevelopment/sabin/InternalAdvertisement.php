...
mysql_query("INSERT INTO IntAdd(IntAdd)"
                    . "VALUES('$Name')");
...
<html>
    ...
    <center><div id='container'>
            ...
            <form method="post" enctype="multipart/form-data" >
                <input type="file" name="file" style="border-style:solid;border-color:white;float:right;width:400px;height:30px"><br><br><br><br>
