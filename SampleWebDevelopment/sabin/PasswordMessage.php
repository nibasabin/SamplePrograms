...
<html>
    ...
    <body style="background-color:#cccccc ;font-size:30;"><br><br>
    <center>
        <div style="heigth:300px;width:906px;border-style:solid;border-width:2px;color:white;background-color:#666666"
             <center>  <br>  <br>
        <center> <br>
            <form method="post" action="UserPage.php">
            <input type="submit"  style="height:30px; width:200px; background-color:blue;color:white ;font-size:20px" value="Back To Home" >
        </form>
        </center>  </div>
    </body>
</html>