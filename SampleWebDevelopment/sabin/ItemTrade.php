...
if (isset($_POST['submit1']))
{
    ...
    {   
        ...
        $Admin=1000;
     mysql_query("INSERT INTO TradeItem(ItemName,TradeWith,ItemDescription,ItemPicture,ItemSellerID,Fname,Lname,Status,AdminId)"
                    . "VALUES('$ItemName','$TradeWith','$ItemDescription','$ItemPicture','$ItemSellerId','$Fname','$Lname','$status','$Admin')");
}
if (isset($_POST['submit3']))
{
    header('Location:TradeMarket.php');
}
?>
<html>
    ...
    <body>
        ...
        <div id="container">
          <form  method="post" enctype="multipart/form-data">
              <div id="box1"><br>
                  <center> <label style="color:white;font-size:20px"> Trade Item:</label></center>
                     
                <div id="box1a"><br>
                    
                    <label style="margin-left:30px;color:white;font-size:20px"> Item Name:</label><br><br>
                    <label style="margin-left:30px;color:white;font-size:20px"> Trade With:</label><br><br>
                ...
                <div id="box1b"><br>
                        ...
                        <input type="text" name="TradeItem" style="width:250px;height:25"><br><br>
